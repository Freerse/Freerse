  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: ColorConstants.inputLineColor, width: 1),
      ...
      child: Column(
        children: <Widget>[
          TextFormField(
            ...
            cursorColor: Color(0xFF57cb3d),
            textDirection: widget.textDirection,
            decoration: InputDecoration(
              enabledBorder:
              UnderlineInputBorder(borderSide: BorderSide(color: Get.isDarkMode ? ColorConstants.dividerColorDark2 : ColorConstants.dividerColor)),
              focusedBorder:
              UnderlineInputBorder(borderSide: BorderSide(color: Get.isDarkMode ? ColorConstants.dividerColorDark2 : ColorConstants.dividerColor)),
              hintText: widget.label,
              hintStyle: TextStyle(color: (Get.isDarkMode ? Color(0xFF515151) : Color(0xFF919191))),
